;(function(_jQuery, window) {
	...
	i18n.set("def", {"fileSelError":"請確認檔案類型,副檔名為","valid.maxUTF8":"不可超過{0}個中文或{1}個英數字","close":"關閉","valid.dateBetween":"結束時間需大於開始時間","confirmTitle":"提示","newData":"新增","fileSelect":"請先選擇檔案","query":"查詢","actoin_001":"是否執行此動作?","sure":"確定","valid.dateBetweenEq":"結束時間需大於等於開始時間","timeout":"伺服器連線逾時，請稍後再試。","loading":"遠端系統《連線中》，請稍待","sessionTimeout":"您的登入己經過期\n請重新登入","mailto":"收件人","fileUploadError":"檔案讀取失敗，請重新上傳","grid_selector":"請選擇資料","currOperOver":"是否離開當前頁面?","selectOption":"選項","fileUploadSuccess":"檔案上傳完成!","lastModBy":"最後修改人","CommaSeparate":"以「,」隔開","connectError":"伺服器連線失敗，請稍後再試，或檢查網路連線是否正常。","no":"否","valid.age":"年齡下限不能大於年齡上限","second":"秒","explain":"說明","fileUploading":"檔案讀取中請耐心等候…","time":"時間","status":"狀態","comboSpace":"","yes":"是","date":"日期","closewindows":"「關閉」 或 「重整」 將會遺失目前編輯中的資料","lastModTm":"最後修改時間"});
	//所有動作均等待i18n 完成後再動作
	(function() {
				...
				$.extend({
					startBlockUI : function(event, xhr) {
						$.blockUI({
							fadeIn : 0,
							fadeOut : 0,
							message : '<div style="margin-top: 8px;"><img style="vertical-align: middle; margin-right: 20px" src="../static/images/ajax-loader-green.gif"/><span>' + i18n.def.loading + '</span></div>',
							css : {
								'z-index' : 10010,
								top : '200px',
								left : '40%',
								backgroundColor : '#fff',
								border : '#48904E 3px solid',
